 ...
 */
export declare const HorizontalScroll: ({ children, getScrollToLeft, getScrollToRight, showArrows, arrowSize, arrowOffsetY, scrollAnimationDuration, getRef, scrollOnAnyWheel, inline, ...restProps }: HorizontalScrollProps) => React.ReactNode;
