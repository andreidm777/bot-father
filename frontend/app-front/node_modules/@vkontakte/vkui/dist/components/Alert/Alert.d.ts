 ...
 */
export declare const Alert: ({ actions, actionsLayout, children, className, style, text, header, onClose, dismissLabel, renderAction, actionsAlign, dismissButtonMode, dismissButtonTestId, getRootRef, ...restProps }: AlertProps) => React.ReactNode;
export {};
