 ...
 */
export declare const Slider: ({ step, min, max, value: valueProp, multiple: multipleProp, defaultValue, disabled, className, getRootRef, getAriaLabel, getAriaValueText, onChange, withTooltip, size, ...restProps }: SliderProps | SliderMultipleProps) => React.ReactNode;
