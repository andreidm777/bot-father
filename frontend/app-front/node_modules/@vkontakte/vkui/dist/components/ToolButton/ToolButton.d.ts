import { AdaptiveIconRendererProps } from '../AdaptiveIconRenderer/AdaptiveIconRenderer';
 ...
 */
export declare const ToolButton: ({ mode, appearance, direction, onClick, className, children, IconCompact, IconRegular, rounded, ...restProps }: ToolButtonProps) => React.ReactNode;
