...
type AllowedFloatingComponentProps = Pick<FloatingComponentProps, 'arrowHeight' | 'arrowPadding' | 'arrowRef' | 'placement' | 'offsetByMainAxis' | 'offsetByCrossAxis' | 'shown' | 'children' | 'onPlacementChange' | 'disableFlipMiddleware'>;
 ...
 */
export declare const OnboardingTooltip: ({ id: idProp, children, shown: shownProp, arrowPadding, arrowHeight, offsetByMainAxis, offsetByCrossAxis, arrowOffset, isStaticArrowOffset, onClose, placement: placementProp, maxWidth, style: styleProp, getRootRef, disableArrow, onPlacementChange, disableFlipMiddleware, ...restProps }: OnboardingTooltipProps) => React.ReactNode;
export {};
