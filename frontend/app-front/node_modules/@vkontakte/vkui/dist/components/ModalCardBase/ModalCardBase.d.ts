 ...
 */
export declare const ModalCardBase: ({ icon, header, headerComponent, subheader, subheaderComponent, children, actions, onClose, dismissLabel, style, size: sizeProp, modalDismissButtonTestId, dismissButtonMode, preventClose, ...restProps }: ModalCardBaseProps) => React.ReactNode;
