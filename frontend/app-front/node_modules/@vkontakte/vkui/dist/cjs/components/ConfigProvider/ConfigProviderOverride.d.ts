 ...
 */
export declare function ConfigProviderOverride({ children, ...contextValue }: ConfigProviderOverrideProps): React.ReactNode;
//# sourceMappingURL=ConfigProviderOverride.d.ts.map