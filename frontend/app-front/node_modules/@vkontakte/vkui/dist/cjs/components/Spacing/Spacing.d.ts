...
export declare const sizesClassNames: Record<SpacingSize, string>;
 ...
 */
export declare const Spacing: ({ size, style, className, ...restProps }: SpacingProps) => React.ReactNode;
