 ...
 */
export declare const ContentCard: ({ subtitle, header, headerComponent, text, caption, className, mode, style, getRootRef, getRef, maxHeight, src, srcSet, alt, width, height, crossOrigin, decoding, loading, referrerPolicy, sizes, useMap, fetchPriority, hasHover, hasActive, ...restProps }: ContentCardProps) => React.ReactNode;
