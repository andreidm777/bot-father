...
export interface EllipsisTextProps extends RootComponentProps<HTMLElement>, HasRootRef<HTMLElement> {
    /**
 ...
 */
declare const EllipsisText: ({ className, getRootRef, children, maxWidth, maxLines, ...restProps }: EllipsisTextProps) => React.ReactNode;
export { EllipsisText };
